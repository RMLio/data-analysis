...
var Daro = function (xml) {
  ...
  function analyze(nodePath, config) {
    ...
    if (nodes.length == 0) {
      ...
      } else if (features == "all" || features == "keys") {
    ...
    if (features == "all" || features == "structure") {
      returnValues.structure = structure;
    }

    if (features == "all" || features == "keys") {
      returnValues.keys = solutions;
    }

    if (features == "all" || features == "datatypes") {
      returnValues.analysis = analysis;
    }
