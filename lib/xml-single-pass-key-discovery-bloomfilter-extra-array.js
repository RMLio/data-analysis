...
var XMLSinglePassKeyDiscoveryBloomFilterExtraArray = function (xml) {
        ...
        for (var j = 0; j < p_a.length; j++) {
          ...
          for (var k = 0; k < paths.length; k++) {
            ...
            if (k == 0) {
              ...
              foundNodes = new BloomFilter(32 * 256, 16);
            }
...
module.exports = {
  XMLSinglePassKeyDiscoveryBloomFilterExtraArray: XMLSinglePassKeyDiscoveryBloomFilterExtraArray
};